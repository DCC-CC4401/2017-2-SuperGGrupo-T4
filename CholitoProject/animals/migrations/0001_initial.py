    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('adoption_state', models.SmallIntegerField(blank=1, choices=[(1, 'En adopción'), (2, 'Procesando Solicitud Adopción'), (3, 'Adoptado')], null=1)),
                ('is_sterilized', models.NullBooleanField(choices=[(True, 'Sí'), (False, 'No')])),
                ('avatar', models.ImageField(default=animals.models.default_avatar, upload_to='animals/')),
