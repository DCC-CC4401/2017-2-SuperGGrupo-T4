...
from ong.views import ONGDispatcherView, ONGIndexView, ONGStatisticsView, \
    ONGEditView, ONGAddAnimalView, ONGRequestsView, ONGFavView, \
    ONGEditAnimalView, ONGCreateAnimalView, ONGEUpdateAnimalView, ONGAnimalView

urlpatterns = [
    url(r'^(?P<pk>\d+)/$', ONGDispatcherView.as_view(),
        name='see-natural-ong'),
